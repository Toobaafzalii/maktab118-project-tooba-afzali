...
const AppProductCard: React.FC<AppProductCardProps> = ({
  ...
  return (
    <Card
      ...
      renderImage={() => (
        <div className="relative w-full" style={{ aspectRatio: "1 / 1" }}>
          ...
          />
          <div className="absolute w-full bottom-0 left-0 right-0 p-4 flex items-center justify-center opacity-0 transition-all duration-500 ease-in-out group-hover:opacity-100">
            <AppButton
    ...
    >
      ...
      <p className="text-title-20 text-light-primary-text-title">{price}</p>
    </Card>
  );
};
